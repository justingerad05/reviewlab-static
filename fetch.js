...
Object.entries(topicMap).forEach(([topic,topicPosts])=>{

const list = topicPosts.map(p=>`
<li><a href="${p.url}">${p.title}</a></li>
`).join("");
...
console.log("✅ AUTHOR + TOPIC 404 FIXED — BUILD COMPLETE");
